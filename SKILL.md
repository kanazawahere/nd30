...
- **Văn bản QPPL** (Nghị quyết HĐND, Quyết định/Chỉ thị QPPL của UBND tỉnh, Thông tư…) → thể thức RIÊNG theo
  **NĐ 78/2025/NĐ-CP + NĐ 187/2025/NĐ-CP**. **KHÔNG bê khuôn NĐ30.** ⚡ **MVP đã có 2026-08-20**: Nghị quyết
  ...
  Xem `references/the-thuc-qppl-nq-hdnd.md` + `examples/nghi_quyet_hdnd.json`. Các loại QPPL khác
  (luật, pháp lệnh, NQ Quốc hội, QĐ/CT QPPL của UBND tỉnh, thông tư, Mẫu 18 NQ-ban-hành-kèm-Quy-định)
  **CHƯA phủ** — phải hỏi lại nếu gặp.
