...
- **Văn bản QPPL** (Nghị quyết HĐND tỉnh, Quyết định/Chỉ thị QPPL của UBND tỉnh, Thông tư…) → thể thức RIÊNG theo
  **NĐ 78/2025/NĐ-CP + NĐ 187/2025/NĐ-CP**. **KHÔNG bê khuôn NĐ30.** ⚡ **MVP đã có 2026-08-20**: Nghị quyết
  HĐND cấp tỉnh (quy định trực tiếp) — Mẫu số 17, **verify thật từ PDF Phụ lục I NĐ 78/2025/NĐ-CP** (tải trực
  tiếp, đọc bằng `pdftotext`, không đoán). Xem `references/the-thuc-qppl-nq-hdnd.md` +
  `examples/nghi_quyet_hdnd.json`. ⚠️ NĐ 187/2025/NĐ-CP có Phụ lục III riêng nhưng file PDF là ảnh scan
  (chưa OCR được) — **CHƯA xác minh** được PL III có Mẫu 17 trùng số hay khác, đừng khẳng định mù. Các
  loại QPPL khác (luật, pháp lệnh, NQ Quốc hội, QĐ/CT QPPL của UBND tỉnh, thông tư, Mẫu 18 NQ-ban-hành-
  kèm-Quy-định) **CHƯA phủ** — phải hỏi lại nếu gặp.
