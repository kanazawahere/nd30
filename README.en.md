...
- **Legal normative documents**: only an MVP for HĐND (People's Council) resolutions at any level
  (Mẫu 17, see `references/the-thuc-qppl-nq-hdnd.md`) — laws, ordinances, National Assembly
  resolutions, provincial People's Committee normative decisions/directives, and circulars are
  not yet covered.
